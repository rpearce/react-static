...
function buildStaticPages(_ref) {
  ...
  return regeneratorRuntime.async(function buildStaticPages$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
      case 0:
        allRoutes = [].concat(routes.indexRoute || []).concat(routes.childRoutes || []);
  ...
  return regeneratorRuntime.async(function callee$0$0$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
      case 0:
         ...
         */
        (0, _mkdirp2['default'])(buildPath, function (e) {
      ...
      case 4:
         ...
         */
        if (js) {
          jsCallback = function jsCallback(e) {
            if (e !== null) {
              console.error(e);
            }
          };

          (0, _child_process.exec)('node_modules/.bin/browserify lib/browser.js | node_modules/.bin/uglifyjs > ' + buildPath + '/app.js', jsCallback);
        }
